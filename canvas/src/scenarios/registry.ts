...
import { tripleVerticalDisplayScenario } from "./triple-vertical/display";
...
// Register triple-vertical scenarios
registry.set("triple-vertical:display", tripleVerticalDisplayScenario);
